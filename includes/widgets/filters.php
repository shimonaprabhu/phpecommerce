...
<form action="search.php" method="post">
	...
	<input type="text" name="max_price" class="price_range" placeholder="Max ₹" value="<?=$max_price;?>"><br>
	...
	<?php endwhile; ?>
	<br>
	<input type="submit" value="search" class="btn btn-xs btn-primary btn-success">
